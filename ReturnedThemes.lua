local themes = {
	...
	default = {
		...
		bordercolor = Color3.fromRGB(39, 39, 42),
		scrollocolor = Color3.fromRGB(30, 28, 28),

		titlecolor = Color3.fromRGB(245, 245, 245),
		descriptioncolor = Color3.fromRGB(180, 180, 180),
		elementdescription = Color3.fromRGB(180, 180, 180),

		primarycolor = Color3.fromRGB(240, 96, 96),

		-- Tabs Themes
		offTextBtn = Color3.fromRGB(80, 80, 80),
		offBgLineBtn = Color3.fromRGB(30, 30, 30),
		onTextBtn = Color3.fromRGB(240, 96, 96),
		onBgLineBtn = Color3.fromRGB(240, 96, 96),

		--#elementsthemes

		-- Toggle
		toggleborder = Color3.fromRGB(240, 96, 96),
		togglebg = Color3.fromRGB(186, 58, 58),

		-- Slider
		sliderbar = Color3.fromRGB(21, 21, 21),
		sliderbarstroke = Color3.fromRGB(35, 35, 35),
		sliderprogressbg = Color3.fromRGB(186, 58, 58),
		sliderprogressborder = Color3.fromRGB(240, 96, 96),
		sliderdotbg = Color3.fromRGB(240, 96, 96),
		...
		itembg = Color3.fromRGB(39, 39, 42),
		itemcheckmarkcolor = Color3.fromRGB(240, 96, 96),
		itemTextOn = Color3.fromHex("#ffffff"),
		itemTextOff = Color3.fromHex("#9a9a9a"),

		valuetext = Color3.fromRGB(255, 255, 255),
		valuebg = Color3.fromRGB(40, 40, 43),
	},
}
